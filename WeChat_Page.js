...
document.getElementById("user_name").innerHTML = "Let's Chat " + user_name + ", in ";
    ...
    firebase.database().ref("/" + room_name).on('value', function (snapshot) {
        document.getElementById("output").innerHTML = ""; snapshot.forEach(function (childSnapshot) {
            childKey = childSnapshot.key; childData = childSnapshot.val(); if (childKey != "purpose") {
                ...
                name_with_tag = "<h4>" + name + "<img class='user_tick' src='tick.png' width=15px></h4>";
...
function deletemsg(message_id) {
    button_id = message_id;
    del = document.getElementById(button_id).value;
